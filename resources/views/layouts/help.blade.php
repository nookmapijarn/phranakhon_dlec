...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="ช่วยเหลือผู้เรียน สกร.ระดับเขตพระนคร">
        <meta name="robots" content="ช่วยเหลือผู้เรียน สกร.ระดับเขตพระนคร">
        <title>{{ config('app.name', 'ช่วยเหลือผู้เรียน-สกร.ระดับเขตพระนคร') }}</title>
