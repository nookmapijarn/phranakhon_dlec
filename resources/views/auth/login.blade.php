<x-guest-layout>
    ...
    <div class="text-center m-2 rounded-lg text-lg text-shadow">ศูนย์ส่งเสริมการเรียนรู้ระดับเขตพระนคร</div>
    <div class="text-center p-1 m-1 text-2xl text-gray-900 ">Phranakhon DLEC</div>
